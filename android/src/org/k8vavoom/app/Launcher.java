...
public class Launcher extends Activity {
  ...
  private void saveCommandLine () {
    ...
    SharedPreferences sh = getSharedPreferences("org.k8vavoom.app.PREF", MODE_PRIVATE);
    SharedPreferences.Editor ed = sh.edit();
    ed.putString("CommandLine", s);
    ed.apply();
  }

  private String loadCommandLine () {
    SharedPreferences sh = getSharedPreferences("org.k8vavoom.app.PREF", MODE_PRIVATE);
    return sh.getString("CommandLine", "");
  }
  ...
  private View.OnClickListener StartVavoomEvent = new View.OnClickListener () {
    ...
    public void onClick (View view) {
      Intent intent = new Intent(Launcher.this, Vavoom.class);
      String s = Launcher.this.cmdline.getText().toString();
      intent.putExtra("CommandLine", s);
  ...
  private void rebuild () {
    ...
    addImage(layout, R.drawable.k8vavoom_logo);
