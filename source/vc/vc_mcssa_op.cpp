...
DECLARE_SSA(DynArrayGetNum2, RegDest, RegSrc, None),
...
DECLARE_SSA(DynArraySetSize1D, RegDest, RegSrc, None),
DECLARE_SSA(DynArraySetSize2D, RegDest, RegSrc, RegSrc),
DECLARE_SSA(DynArrayElement2D, RegDest, TypeSize, None),
