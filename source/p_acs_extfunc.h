  ...
  ACS_EXTFUNC(PlaySound)
  ACS_EXTFUNC(StopSound)
  ACS_EXTFUNC(strcmp)
  ACS_EXTFUNC(stricmp)
  ACS_EXTFUNC(StrLeft)
  ACS_EXTFUNC(StrRight)
  ACS_EXTFUNC(StrMid)
  ACS_EXTFUNC(GetActorClass)
