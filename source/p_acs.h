...
enum EPCD
{
  ...
  DECLARE_PCD(SaveString),//352, UNINMPLEMENTED
  DECLARE_PCD(PrintMapChRange),//353, UNINMPLEMENTED
  DECLARE_PCD(PrintWorldChRange),//354, UNINMPLEMENTED
  DECLARE_PCD(PrintGlobalChRange),//355, UNINMPLEMENTED
  ...
  DECLARE_PCD(PushFunction),//359, UNINMPLEMENTED

  DECLARE_PCD(CallStack),//360, UNINMPLEMENTED
