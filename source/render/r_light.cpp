...
# define VV_SHADOWMAP_DEFAULT_DBG  "1"
#else
# define VV_SHADOWMAP_DEFAULT      false
# define VV_SHADOWMAP_DEFAULT_DBG  "0"
#endif
VCvarB r_shadowmaps("r_shadowmaps", VV_SHADOWMAP_DEFAULT, "Use shadowmaps instead of shadow volumes?", CVAR_PreInit);
VCvarI dbg_shadowmaps("dbg_shadowmaps", VV_SHADOWMAP_DEFAULT_DBG, "Show shadowmap cubemap?", CVAR_PreInit);
