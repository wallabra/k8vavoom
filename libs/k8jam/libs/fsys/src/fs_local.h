...
public:
  ...
  virtual EWadNamespace LumpNamespace (int LumpNum) = 0;
...
public:
  ...
  virtual EWadNamespace LumpNamespace (int LumpNum) override;
...
public:
  ...
  void Open (const VStr &FileName, VStream *InStream);
...
public:
  VStreamFileReader (FILE*, const VStr &afname);
